...
from shop import db , app, Access
...
def getCart():
    ...
    return render_template('products/carts.html',tax=tax, grandtotal=grandtotal,brands=brands(),categories=categories(),user_auth = user)
